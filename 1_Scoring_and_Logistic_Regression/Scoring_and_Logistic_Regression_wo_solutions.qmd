...
-   Data set 1:
    -   Class 0: mixture of $\begin{bmatrix} 5 & 8 \\ 2 & 3 \end{bmatrix}$ $\begin{bmatrix} 5 & 8 \\ 2 & 3 \end{bmatrix}$
    -   Class 1: mixture of $\begin{bmatrix} 5 & 8 \\ 2 & 3 \end{bmatrix}$ $\begin{bmatrix} 5 & 8 \\ 2 & 3 \end{bmatrix}$
-   Data set 2 (generative approach, assumptions of QDA): Given $\mu_0$, $\mu_1$, $\Sigma_0$ and $\Sigma_1$ and $X$ having values in $\mathbb R^2$:

$X|Y=0 \sim\mathcal N[\mu_0,\Sigma_0]$ $X|Y=1 \sim\mathcal N[\mu_1,\Sigma_1]$ $\mathbb{P}[Y=1]=\pi$
